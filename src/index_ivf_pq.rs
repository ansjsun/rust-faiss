...
//     ) -> Self {
//         unsafe {
//             cpp!([dimension as "int", nprobe as "int", nhash as "int", doc_size as "int"] ->  IndexIVFPQ as "faiss::IndexIVFPQ"{
...
//                 faiss::IndexIVFPQ *index = new faiss::IndexIVFPQ(coarse_quantizer, dimension, ncentroids, metric);
